...
export default function Dashboard() {
  ...
  const [abonement, setAbonement] = useState<Abonement>({} as Abonement);
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const abonementData = await apiGetFetcher(`/visitors/${id}/abonement`);
  ...
  const activeDepartment = abonement
    ? departments.find((d) => d.department_id === abonement.department_id)
    : null;
